...
<html>
  <head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="http://sistemasmicrocontrolados.com/imagenes/gt_icon.ico">
    <!-- caracteres-->
    <meta charset="utf-8">
  ...
  <style type="text/css">
    body{
      background-image: url(http://sistemasmicrocontrolados.com/imagenes/NEON.png);
...
<body class="bg-secondary a">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      ...
      <ul class="navbar-nav mr-auto ">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="./clientes.php"> <strong>Usuarios</strong><span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
  ...
  <!-- Start Container-->
  <div id="usuarios" class="container"><br>
        <h3 class="h3">Configuración de Usuarios</h3><br>
        <div class="container ">
              <div class="row justify-content-center m-5">
                <div class="col  mt-3 mx-3 ">
                  <div class="card" style="width:230px">
                     <img class="card-img-top " src="http://sistemasmicrocontrolados.com/imagenes/userAdd.png" alt="User Add" style="width:100%">
                     ...
                     <div class="card-body"> <!--Use .card-title to add card titles to any heading element. The .card-text class is used to remove bottom margins for a <p> element if it is the last child (or the only one) inside .card-body. The .card-link class adds a blue color to any link, and a hover effect. -->
                         <h5 class="card-title">Click to add User</h5>
                         <p class="card-text"></p>
                         <a href="clientes/addclient.php" class="btn btn-outline-info stretched-link btn-block"> Agregar</a> <!--Add the .stretched-link class to a link inside the card, and it will make the whole card clickable and hoverable (the card will act as a link) -->
                     </div>
                  </div>
                </div>
                <div class="col  mt-3 mx-3">
                  <div class="card" style="width:230px">
                     <img class="card-img-top" src="http://sistemasmicrocontrolados.com/imagenes/userEdit.png" alt="Card image" style="width:100%">
                     <div class="card-body">
                         <h5 class="card-title">Click to Edit User</h5>
                         <p class="card-text"></p>
                         <a href="clientes/editClient.php" class="btn btn-outline-success stretched-link btn-block">Editar</a>
                     </div>
                  </div>
                </div>
                <div class="col  mt-3 mx-3">
                  <div class="card" style="width:230px">
                     <img class="card-img-top" src="http://sistemasmicrocontrolados.com/imagenes/userDelete.png" alt="Card image" style="width:100%">
                     <div class="card-body">
                         <h5 class="card-title">Click to Delete User</h5>
                         <p class="card-text"></p>
                         <a href="clientes/deleteClient.php" class="btn btn-outline-danger stretched-link btn-block">Delete </a>
                     </div>
                  </div>
                </div>
              </div>
