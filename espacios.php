...
<body class="bg-secondary a">
    ...
    <!-- Navbar content -->
     <a class="navbar-brand" href="#">
      <img src="http://sistemasmicrocontrolados.com/imagenes/gt_icon.ico" width="30" height="30" class="d-inline-block align-top rounded img-fluid" alt="Gigaticket">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      ...
      <ul class="navbar-nav mr-auto ">
       ...
       <a class="navbar-brand" href="#">
      <img src="http://sistemasmicrocontrolados.com/imagenes/aragon.jpg" width="40" height="40" class="d-inline-block align-top rounded img-fluid mx-2" alt="fes aragon">
    </a>
  </div>
  </nav>
         ...
         <div class="row ">
          ...
          <div class="col ">
               <div class="card" style="width:200px">
                   <img class="card-img-top" src="http://sistemasmicrocontrolados.com/imagenes/workSpace.png" alt="Card image" style="width:100%">
                   <div class="card-body">
